...
本文已收录到我免费开源的 [《Vibe Coding 零基础入门教程》](https://ai.codefather.cn/vibe)，上千张图、几十万字，完全免费开源，从零基础快速学会 AI 编程，再到做出自己的产品、跑通变现全流程，一次拿捏。
...
来自: [傻子可懂的 Harness Engineering 入门教程 + 项目实战，一次搞懂 AI 编程工程化！ - 程序员鱼皮 - 博客园](https://www.cnblogs.com/yupi/p/19932316)